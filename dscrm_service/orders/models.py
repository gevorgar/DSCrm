...
class Order(models.Model):
    ...
    order_description = models.CharField(verbose_name="Неисправность")
    ...
    services = models.ManyToManyField('services.Service', through='services.ServiceItem', verbose_name="Услуга", blank=True)
